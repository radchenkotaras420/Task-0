...
NumButtons('1').grid(row = 4,column = 2,stick='wens',padx=5,pady=5)
NumButtons('2').grid(row = 4,column = 3,stick='wens',padx=5,pady=5)
NumButtons('3').grid(row = 4,column = 4,stick='wens',padx=5,pady=5)
...
NumButtons('7').grid(row = 2,column = 2,stick='wens',padx=5,pady=5)
NumButtons('8').grid(row = 2,column = 3,stick='wens',padx=5,pady=5)
NumButtons('9').grid(row = 2,column = 4,stick='wens',padx=5,pady=5)
